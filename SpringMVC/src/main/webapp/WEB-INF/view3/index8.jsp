      ...
      <main role="main" class="main-content">
        <div class="container-fluid">
          <div class="row justify-content-center">
            <div class="col-12">
              <h2 class="page-title">재실정보</h2>
              <p class="text-muted">재실 정보를 입력해주시면 전력 예측에 도움이 됩니다.</p>
              <div class="card shadow mb-4">
                <div class="card-header">
                  <strong class="card-title">정보입력</strong>
                </div>
                <div class="card-body">
                  <div class="row">
                    <!-- 넣기 -->
                    <div class="col-md-6">
                      <div class="form-group mb-3">
                        <label for="simpleinput">가구원 수</label>
                        <input type="text" id="simpleinput" class="form-control"placeholder="1">
                      </div>
                      
              
                        <label for="simpleinput">취미 활동</label>
                        <div class="custom-control custom-radio">
                          <input type="radio" id="customRadio1" name="customRadio" class="custom-control-input">
                          <label class="custom-control-label" for="customRadio1">집안에서 활동하시나요?</label>
                        </div>
                        <div class="custom-control custom-radio">
                          <input type="radio" id="customRadio2" name="customRadio" class="custom-control-input" checked>
                          <label class="custom-control-label" for="customRadio2">집밖에서 활동하시나요?</label>
                        </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-group mb-3">
                        <label for="custom-select">월 소득수준</label>
                        <select class="custom-select" id="custom-select">
                          <option selected>클릭하여 선택해주세요.</option>
                          <option value="1">월 300만원 이하</option>
                          <option value="2">월 300만원 - 600만원</option>
                          <option value="3">월 600만원 이상</option>
                        </select>
                      </div>
