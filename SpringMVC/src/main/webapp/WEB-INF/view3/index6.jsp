              ...
              <div class="col-md-6 mb-4">
                <div class="card shadow">
                  ...
                  <div class="card-body">
                   ...
                   <form action="${cpath}/flask.do" method="post" name='fla'>
                    <input type="hidden" value="${sessionScope.id}" name="id" class="fla_id">
                     <button type="submit" class="btn mb-2 btn-primary btn-lg btn-block">예측 시작하기</button> 
                   <!-- <input type="button" value="확인" name="wirte" class="btn btn-lg btn-primary btn-block">-->
                  	</form>
                  </div> <!-- /. card-body -->
                </div> <!-- /. card-body -->
              </div> <!-- /. col -->
