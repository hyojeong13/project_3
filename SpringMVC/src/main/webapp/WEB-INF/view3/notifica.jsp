          ...
          <div class="row justify-content-center">
            <div class="col-12 col-lg-10 col-xl-8">
              ...
              <div class="my-4">
                ...
                <p>원하시는 알람 설정을 도와드립니다.</p>
                <hr class="my-4">
                <strong class="mb-0">보안</strong>
                <p>제어 보안 경고알림이 전송됩니다.</p>
                <div class="list-group mb-5 shadow">
                  <div class="list-group-item">
                    <div class="row align-items-center">
                      <div class="col">
                        <strong class="mb-0">비정상적인 활동 알림</strong>
                        <p class="text-muted mb-0">비정상적인 활동을 자동을 확인하여 알려드립니다.</p>
                      </div> <!-- .col -->
                      <div class="col-auto">
                  ...
                  <div class="list-group-item">
                    <div class="row align-items-center">
                      <div class="col">
                        <strong class="mb-0">무단 침입 알림</strong>
                        <p class="text-muted mb-0">무단으로 침임한 자를 알려드립니다.</p>
                      </div> <!-- .col -->
                      <div class="col-auto">
                        <div class="custom-control custom-switch">
                ...
                <hr class="my-4">
                <strong class="mb-0">시스템</strong>
                <p>시스템 경고를 활성화하십시오.</p>
                <div class="list-group mb-5 shadow">
                  <div class="list-group-item">
                    <div class="row align-items-center">
                      <div class="col">
                        <strong class="mb-0">새로운 기능 및 업데이트에 대해 알림.</strong>
                        <p class="text-muted mb-0">이벤트들을 알려드립니다.</p>
                      </div> <!-- .col -->
                      <div class="col-auto">
                        <div class="custom-control custom-switch">
                  ...
                  <div class="list-group-item">
                    <div class="row align-items-center">
                      <div class="col">
                        <strong class="mb-0">예측정보를 이메일로 알려주시면 됩니다.</strong>
                        <p class="text-muted mb-0">이메일로 알려드립니다.</p>
                      </div> <!-- .col -->
                      <div class="col-auto">
                        <div class="custom-control custom-switch">
                  ...
                  <div class="list-group-item">
                    <div class="row align-items-center">
                      <div class="col">
                        <strong class="mb-0">계정 사용에 대한 팁에 대해 알려주십시오.</strong>
                        <p class="text-muted mb-0">팁을 알려드립니다.</p>
                      </div> <!-- .col -->
                      <div class="col-auto">
                        <div class="custom-control custom-switch">
