            ...
            <li class="nav-item dropdown">
              ...
              <ul class="collapse list-unstyled pl-4 w-100" id="dashboard">
                <li class="nav-item active">
                  <a class="nav-link pl-3" href="${cpath}/myapp/index.do"><span class="ml-1 item-text">Default</span></a>
                </li>
                <li class="nav-item">
                  <a class="nav-link pl-3" href="${cpath}/myapp/dashboard_analytics.do"><span class="ml-1 item-text">Analytics</span></a>
                </li>
                <li class="nav-item">
          ...
          <ul class="navbar-nav flex-fill w-100 mb-2">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="collapse list-unstyled pl-4 w-100" id="profile">
                <a class="nav-link pl-3" href="${cpath}/myapp/profile.do"><span class="ml-1">Overview</span></a>
