      ...
      <aside class="sidebar-left border-right bg-white shadow" id="leftSidebar" data-simplebar>
        ...
        <nav class="vertnav navbar navbar-light">
          ...
          <div class="w-100 mb-4 d-flex">
            <a class="navbar-brand mx-auto mt-2 flex-fill text-center" href="http://localhost:8081/myapp/index.do">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="collapse list-unstyled pl-4 w-100" id="dashboard">
                <li class="nav-item active">
                  <a class="nav-link pl-3" href="http://localhost:8081/myapp/index4.do"><span class="ml-1 item-text">기기등록</span></a>
                </li>
                <li class="nav-item">
                  <a class="nav-link pl-3" href="http://localhost:8081/myapp/index2.do"><span class="ml-1 item-text">원격접속</span></a>
                </li>
          ...
          <ul class="navbar-nav flex-fill w-100 mb-2">
            <li class="nav-item dropdown">
              ...
              <ul class="collapse list-unstyled pl-4 w-100" id="ui-elements">
                <li class="nav-item">
                  <a class="nav-link pl-3" href="http://localhost:8081/myapp/index.do"><span class="ml-1 item-text">실시간 사용량</span>
                  </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link pl-3" href="http://localhost:8081/myapp/index3.do"><span class="ml-1 item-text">월별 사용량</span></a>
                </li>
          ...
          <div class="btn-box w-100 mt-4 mb-1">
            <a href="http://localhost:8081/myapp/loginForm.do" target="_blank" class="btn mb-2 btn-primary btn-lg btn-block">
                  ...
                  <div class="card-body">
                    <div class="row mt-1 align-items-center">
                      <div class="col-12 col-lg-4 text-left pl-4">
                        <p class="mb-1 small text-muted"> 금월 예상 전기료</p>
                        <span class="h3">￦ 83,121 원</span>
                        <span class="small text-muted">+12%</span>
                        <span class="fe fe-arrow-up text-success fe-12"></span>
                        <p class="text25"> 전년도 대비 전력 사용율 12% 증가 </p>
                      </div>
                      <div class="col-6 col-lg-2 text-center py-4">
                        <p class="mb-1 small text-muted">지난달 전기료</p>
                        <span class="h3">￦ 71,620원</span><br />
                        <span class="small text-muted">+20%</span>
                        <span class="fe fe-arrow-up text-success fe-12"></span>
                      </div>
                      <div class="col-6 col-lg-2 text-center py-4 mb-2">
                        <p class="mb-1 small text-muted">현재 월 전기료</p>
                        <span class="h3">￦ 42,758원</span><br />
                    ...
                    <div class="contbox">
                      ...
                      <h2 class="ampre">월별 전력 사용량</h2>
                        <canvas id="myChart" width="2654" height="2654" style="width: 1327px;height: 400px;"></canvas>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-12 col-lg-8">
                        <div class="card shadow">
                          <div class="card-header">
                            <strong class="card-title">월별 전력 내역</strong>
                            <a class="float-right small text-muted" href="#!">View all</a>
                          </div>
...
var data = {
  ...
  datasets: [
  {
    ...
    data: [165, 209, 180, 381, 456, 255, 140, 142,143,118,245,289] },
