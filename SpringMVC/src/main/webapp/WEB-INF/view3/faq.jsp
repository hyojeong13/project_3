          ...
          <div class="row justify-content-center">
            <div class="col-12">
              <div class="w-50 mx-auto text-center justify-content-center py-5 my-5">
                <h2 class="page-title mb-0">무엇을 도와드릴까요?</h2>
                <p class="lead text-muted mb-4">검색해주세요.</p>
                <form class="searchform searchform-lg">
                  ...
                  <p class="help-text mt-2 text-muted">밑에 키워드를 입력해주시면 친절히 알려드립니다.</p>
                </form>
              </div>
              <div class="row my-4">
                <div class="col-6 col-lg-3">
                  <div class="card shadow mb-4">
                    <div class="card-body">
                      ...
                      <a href="#">
                        <h3 class="h5 mt-4 mb-1">시작방법</h3>
                      </a>
                      <p class="text-muted">시작하는 방법을 알려드립니다.</p>
                    </div> <!-- .card-body -->
                  </div> <!-- .card -->
                </div> <!-- .col-md-->
                <div class="col-6 col-lg-3">
                ...
                <div class="col-6 col-lg-3">
                  <div class="card shadow mb-4">
                    <div class="card-body">
                      ...
                      <a href="#">
                        <h3 class="h5 mt-4 mb-1">지식자료</h3>
                      </a>
                      <p class="text-muted">제품에 대해 자세히 알아보세요.</p>
                    </div> <!-- .card-body -->
                  </div> <!-- .card -->
                </div> <!-- .col-md-->
                <div class="col-6 col-lg-3">
                  <div class="card shadow">
                    <div class="card-body">
                      ...
                      <a href="#">
                        <h3 class="h5 mt-4 mb-1">보고</h3>
                      </a>
                      <p class="text-muted">버그 보고</p>
                    </div> <!-- .card-body -->
                  </div> <!-- .card -->
                </div> <!-- .col-md-->
              </div> <!-- .row -->
                ...
                <div class="col-md-6">
                  <div class="card shadow bg-success text-center mb-4">
                    <div class="card-body p-5">
                      ...
                      <h3 class="h4 mt-4 mb-1 text-white">라이브 채팅</h3>
                      <p class="text-white mb-4">실시간 채팅으로 모르는 것을 안내해드립니다. </p>
