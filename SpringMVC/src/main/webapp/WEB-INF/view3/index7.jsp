                ...
                <div class="card-body p-5">
                  <div class="row mb-5">
                    <div class="col-12 text-center mb-4">
                      <img src="./assets/images/logo.svg" class="navbar-brand-img brand-sm mx-auto mb-4" alt="..." style="width: 30%;">
                      <h2 class="mb-0 text-uppercase">구매현황</h2>
                  ...
                  <table class="table table-borderless table-striped">
                    <thead>
                      <tr>
                        <th scope="col">#</th>
                        <th scope="col">패키지 상품명</th>
                        <th scope="col" class="text-right">구매가격</th>
                        <th scope="col" class="text-right">날짜</th>
                        <th scope="col" class="text-right">상황</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr>
                        ...
                        <td class="text-right">2019.01.01 - 2019.02.01</td>
                        <td class="text-right">구매완료</td>
                      </tr>
                      <tr>
                        <th scope="row">2</th>
                        <td> 스마트홈 패키지 PRO (1년)
                        ...
                        <td class="text-right">2019.02.02 - 2020.02.01</td>
                        <td class="text-right">구매완료</td>
                      </tr>
                      <tr>
                        <th scope="row">3</th>
                        ...
                        <td class="text-right">2019.02.02 - 2021.02.01</td>
                        <td class="text-right">구매완료</td>
                      </tr>
                    </tbody>
                  </table>
